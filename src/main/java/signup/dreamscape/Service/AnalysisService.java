...
import signup.dreamscape.Entity.DreamAnalysisEntity; // 로컬에서 추가
import signup.dreamscape.Repository.DreamAnalysisRepository; // 로컬에서 추가
...
public class AnalysisService {
    ...
    private final DreamAnalysisRepository dreamAnalysisRepository; // 로컬에서 추가
...
//            DreamEntity savedDream = dreamRepository.save(dreamEntity); // 레포지토리가 디비에 저장
            ...
            // 로컬에서 추가 (DreamAnalysisEntity에 mood를 저장)
            DreamAnalysisEntity analysis = dreamAnalysisRepository
                    .findByDream_DreamId(savedDream.getDreamId())
                    .orElseGet(DreamAnalysisEntity::new);

            analysis.setDream(savedDream);
            analysis.setTextSummary(summaryText);
            analysis.setMood(savedDream.getMood());
